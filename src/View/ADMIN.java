...
public class ADMIN extends JFrame {
    ...
    public ADMIN() throws IOException {
        ...
        textField_lichngaybay.setBounds(185, 70, 153, 34);
        ...
        textField_lichgiobay.setBounds(185, 115, 153, 34);
        ...
        textField_lichsucchua.setBounds(521, 115, 153, 34);
        ...
        comboBox_lichkhoihanh.setBounds(185, 159, 153, 34);
        ...
        comboBox_lichhacanh.setBounds(521, 25, 153, 34);
        ...
        comboBox_lichhangbay.setBounds(521, 70, 153, 34);
        panel_lichbay.add(comboBox_lichhangbay);

        JPanel panel_themsuaxoa = new JPanel();
        panel_themsuaxoa.setBackground(Color.white);
        panel_themsuaxoa.setBounds(716, 0, 265, 195);
        ...
        btnNewButton_chinhsua.setBounds(10, 55, 180, 35);
        ...
        btnNewButton_xoa.setBounds(10, 100, 180, 35);
        ...
        btnNewButton_them.setBounds(10, 10, 180, 35);
        ...
        btnNewButton_6.setBounds(10, 145, 180, 35);
        panel_themsuaxoa.add(btnNewButton_6);
    ...
    public void themhoaccapnhapchuyenbay(EditLichBay lb) {
        ...
        this.dsLichBay.kiemtragiobay(lb);
